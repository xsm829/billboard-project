...
//        System.out.println(searchModel.toString());
        ...
        if (role.equals("0"))
            ...
            request.getRequestDispatcher(request.getContextPath() + "/postlist.jsp").forward(request, response);
        else if (role.equals("2"))
            request.getRequestDispatcher(request.getContextPath() + "/article.jsp").forward(request, response);
        else if (role.equals("3"))
            request.getRequestDispatcher(request.getContextPath() + "/updatepost.jsp").forward(request, response);
